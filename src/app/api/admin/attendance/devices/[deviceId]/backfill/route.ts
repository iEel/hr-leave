...
import { runAttendanceBackfill } from '@/lib/attendance/sync-service';
...
export async function POST(
    ...
    try {
        ...
        await logAudit({
            ...
            action: 'BACKFILL_ATTENDANCE_DEVICE',
        ...
        console.error('Error backfilling attendance device:', error);
        return NextResponse.json({ error: 'Failed to backfill attendance device' }, { status: 500 });
    }
}
